    ...
    <footer className="py-4 border-top border-secondary mt-5" style={{backgroundColor: '#0a0a0a'}}>
      <div className="container text-center">
        <div className="mb-3">
          ...
          <a href="https://www.linkedin.com/in/vedant-agale/" className="text-white mx-3 fs-4 gold-hover"><FaLinkedin /></a>
          <a href="https://www.instagram.com/vedant_agalle/" className="text-white mx-3 fs-4 gold-hover"><FaInstagram /></a>
